...
export default class TopBar extends React.Component {
    ...
    render() {
        ...
        return React.createElement("header", { className: "mdc-top-app-bar mdc-top-app-bar--fixed" },
            React.createElement("div", { className: "mdc-top-app-bar__row" },
                ...
                React.createElement("section", { className: "mdc-top-app-bar__section mdc-top-app-bar__section--align-end", role: "toolbar" },
                    React.createElement("button", Object.assign({ className: "mdc-top-app-bar__action-item mdc-icon-button mdc-icon-button", onClick: this.props.adapter.onGithubClick, title: model.sourceButtonLabel }, { 'data-testid': 'github-button' }),
                        React.createElement("svg", { viewBox: "0 0 16 16", version: "1.1", "aria-hidden": "true", className: "mdc-icon-button__icon" },
